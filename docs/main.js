...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.addCoupon = function (coupon) {
        return this.http.post(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('createcoupon'), coupon);
    };
    ApiService.prototype.addshop = function (shop) {
        return this.http.post(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('addshop'), shop);
    };
    ApiService.prototype.stopdeal = function (couponid) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('stopdeal/' + couponid, ''));
    };
    ApiService.prototype.getuser = function (user) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('getuser/' + user));
    };
    ApiService.prototype.setuser = function (user) {
        return this.http.post(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('setuser/' + user["_id"]), user);
    };
    ApiService.prototype.getoldcoupons = function (shopid) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('getoldcoupons/' + shopid, ''));
    };
    ApiService.prototype.flash = function (user, couponid, gift) {
        if (gift === void 0) { gift = false; }
        var s = "";
        if (gift)
            s = "?gift";
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('flash/' + couponid + '/' + user + s, ''));
    };
    ApiService.prototype.removeCoupon = function (idcoupon, bDelete) {
        if (bDelete === void 0) { bDelete = false; }
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('removecoupon/' + idcoupon + "/" + bDelete, ''));
    };
    ApiService.prototype.removeShop = function (id) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('removeshop/' + id, ''));
    };
    ApiService.prototype.gettokenforimagesearchengine = function () {
        return this.http.get("https://server.f80.fr:5800/auth?username=reducshare&password=hh");
    };
    ApiService.prototype.getcouponinsquare = function (param) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('getcouponinsquare/' + param.x0 + '/' + param.y0 + '/' + param.x1 + '/' + param.y1, ''));
    };
    ApiService.prototype.follow = function (userid, operation, shopid) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('updatefollow/' + userid + '/' + operation + '/' + shopid, ''));
    };
    ApiService.prototype.delegate = function (userid, shopid, operation) {
        if (operation === void 0) { operation = "*"; }
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('delegate/' + shopid + '/' + operation + '/' + userid, ''));
    };
    ApiService.prototype.adduser = function (email, firstname, tags) {
        if (firstname === void 0) { firstname = ""; }
        if (tags === void 0) { tags = ""; }
        if (firstname == "")
            firstname = "null"; //sinon l'appel de l'api n'est pas correct
        if (tags == "")
            tags = "null"; //sinon l'appel de l'api n'est pas correct
        var url = Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])('adduser/' + email + '/' + firstname + "/" + tags);
    ...
    ApiService.prototype.getcoupons = function () {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("getcoupons/" + _tools__WEBPACK_IMPORTED_MODULE_3__["ADMIN_PASSWORD"]));
    };
    ApiService.prototype.getshops = function () {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("getshops/" + _tools__WEBPACK_IMPORTED_MODULE_3__["ADMIN_PASSWORD"]));
    };
    ApiService.prototype.getmoneys = function () {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("getmoneys/" + _tools__WEBPACK_IMPORTED_MODULE_3__["ADMIN_PASSWORD"]));
    };
    ...
    ApiService.prototype.updateCoupon = function (coupon_id, field, value) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("updatecoupon/" + coupon_id + "/" + field + "/" + value));
    };
    ...
    ApiService.prototype.getUsersFromCoupon = function (coupon, limit) {
        if (limit === void 0) { limit = 10; }
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("getusersfromcoupon/" + coupon.origin + "/" + limit));
    };
    ...
    ApiService.prototype.drop = function (coupon, lat, lng, nbr) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("dropcoupon/" + coupon['_id'] + "/" + lat + "/" + lng + "/" + nbr));
    };
    ApiService.prototype.getCouponsAround = function (lng, lat) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("getcouponsaround/" + lng + "/" + lat));
    };
    ApiService.prototype.getTransactions = function (user_id, shopid) {
        if (shopid === void 0) { shopid = ""; }
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("gettransactions/" + user_id + "/" + shopid));
    };
    ApiService.prototype.tirage = function (couponid, gain, limit) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("tirage/" + couponid + "/" + gain + "/" + limit));
    };
     ...
     * @param coupon
     */
    ApiService.prototype.use = function (coupon) {
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("use/" + coupon._id));
    };
    /**
     * Demande la validation du coupon par le vendeur
     * @param coupon
     */
    ApiService.prototype.ask = function (coupon, update_value) {
        if (update_value === void 0) { update_value = true; }
        return this.http.get(Object(_tools__WEBPACK_IMPORTED_MODULE_3__["api"])("ask/" + coupon._id + "/" + update_value));
    };
...
module.exports = __webpack_require__(/*! C:\Users\hhoar\IdeaProjects\ticketShare\src\main.ts */"./src/main.ts");
